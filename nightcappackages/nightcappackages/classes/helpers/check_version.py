...
class NightcapPackageVersionCheckHelper(object):
    # region Init
    def __init__(self, main: bool, cfgMain: bool, current_build: str, current_version: str, verbose: bool = False):
        self.tmpdir = None
    ...
    def check(self) -> None:
        ...
        try:
            ...
            if status_code == 200:
                ...
                if self.configMainBranch == self.isMainBranch and _current_build == _remote_build and _current_version == _remote_version:
