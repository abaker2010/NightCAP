...
from nightcappackages.classes.helpers.check_version import (
    NightcapPackageVersionCheckHelper,
)
from nightcappackages.classes.commands.get_updater import (
...
class NightcapPackageUpdaterCommand(Command):
    ...
    def __init__(
        self,
        config: NightcapCLIConfiguration,
        main: bool,
        verbose: bool = False,
        force=False,
    ):
