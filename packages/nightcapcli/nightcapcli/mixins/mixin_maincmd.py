...
class NightcapCLICMDMixIn(NightcapMainCMD):
    ...
    def complete_use(self, text, line, begidx, endidx):
        return [i for i in NightcapOptionGenerator(self.selectedList).completed_options() if i.startswith(text)]
    ...
    def do_use(self, line: str, override: object = None):
        ...
        try:
            ...
            if _validator:
                ...
                NightcapCLIPublisher().dispatch(self.channelID, NightcapCLIPublisher().directions)
            else:
