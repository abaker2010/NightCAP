...
class WaitingPrinter(PrinterBase):
    ...
    def print_waiting(self, leadingTab=2, leadingText="[-]", text="", optionalText="", leadingBreaks=0, endingBreaks=0, vtabs=0,seperator=' -> ', 
            ...
            self.animated_base_print(leadingText=leadingText, leadingTab=leadingTab, text=text, optionalText=optionalText, leadingBreaks=leadingBreaks,
