...
class PrinterBase:
    ...
    def base_print(self, leadingTab=1, leadingText="", text="", optionalText="", leadingBreaks=0, endingBreaks=0, vtabs=0, seperator=' : ',
    leadingColor=Fore.LIGHTGREEN_EX, textColor=Fore.LIGHTGREEN_EX,
    ...
    def animated_base_print(self, leadingTab=1, leadingText="", text="", optionalText="", leadingBreaks=0, endingBreaks=0, vtabs=0, seperator=' : ',
    leadingColor=Fore.LIGHTGREEN_EX, textColor=Fore.LIGHTGREEN_EX,
                    optionalTextColor=Fore.LIGHTGREEN_EX, breakTextColor=Fore.LIGHTMAGENTA_EX, styleRest=Style.RESET_ALL):
        _start = ("\v"*vtabs ) + ('\n'*leadingBreaks)
        _leading = ("\t" * leadingTab) + ' ' + leadingColor + leadingText
