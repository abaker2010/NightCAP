...
class BTCCracker(NightcapRedTeam):
    """ 
        This is used to try and crack BTC Wallets
    """
    #region Overview
    ...
    def onProcess(self):
        ...
        try:
            self.printer.print_formatted_check("Process data")
...
def main():
    ...
    try:
        ...
        ncore.printer.print_underlined_header("Cracking BTC Wallets")
        ncore.run()
